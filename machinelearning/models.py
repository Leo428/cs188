...
class RegressionModel(object):
    ...
    def __init__(self):
        ...
        self.w4 = nn.Parameter(64, 64)
        self.b4 = nn.Parameter(1, 64)
        self.w5 = nn.Parameter(64, 1)
    ...
    def run(self, x):
        ...
        fourth_layer = nn.ReLU(nn.AddBias(nn.Linear(third_layer, self.w4), self.b4))
        output_layer = nn.AddBias(nn.Linear(fourth_layer, self.w5), self.b5)
        return output_layer
...
class DigitClassificationModel(object):
    ...
    def __init__(self):
        ...
        self.w5 = nn.Parameter(49, 24)
        self.b5 = nn.Parameter(1, 24)
        self.w6 = nn.Parameter(24, 10)
    ...
    def run(self, x):
        ...
        third_layer = nn.ReLU(nn.AddBias(nn.Linear(second_layer, self.w3),self.b3))
        fourth_layer = nn.ReLU(nn.AddBias(nn.Linear(third_layer, self.w4), self.b4))
        fifth_layer = nn.ReLU(nn.AddBias(nn.Linear(fourth_layer, self.w5), self.b5))
        output_layer = nn.AddBias(nn.Linear(fifth_layer, self.w6), self.b6)
        return output_layer
...
class LanguageIDModel(object):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        self.learning_rate = 0.1
        self.w = nn.Parameter(self.num_chars, 512)
        self.b = nn.Parameter(1, 512)
        self.hidden_w = nn.Parameter(512, 512)        
        self.final_w = nn.Parameter(512, len(self.languages))
        self.final_b = nn.Parameter(1, len(self.languages))
        self.params = [self.w, self.hidden_w, self.b, self.final_w, self.final_b]
    ...
    def run(self, xs):
        ...
        """
        "*** YOUR CODE HERE ***"
        h_i = nn.ReLU(nn.AddBias(nn.Linear(xs[0], self.w), self.b))
        for x in xs[1:]:
            z = nn.Add(nn.Linear(x, self.w), nn.Linear(h_i, self.hidden_w))
            h_i = nn.ReLU(nn.AddBias(z, self.b))
        result = nn.AddBias(nn.Linear(h_i, self.final_w), self.final_b)
        return result
